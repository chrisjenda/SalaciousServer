...
public class UserPlayerDao {
    ...
    private static ResultSet parseDB(String sql, String... params) throws SQLException {
        ...
        String dbpath = ZomboidFileSystem.instance.getCacheDir() +
                "/db/" + zombie.network.GameServer.ServerName + ".db";
        ...
        if (isValidPlayer(username)) {
            try {
                ...
                if (result.next()) {
                    ...
                    DebugLog.log(DebugType.Network, "WEBSERVERDBG: User Data Result: " +
                            " Name: " + playername +
                            " Password: " + hashedpass +
