...
public class AsmUtils {
  ...
  public static @Nullable AbstractInsnNode getFirstNode(
   ...
   * list of instructions. Note that label nodes will not be altered in any way, they are only used
   * to mark the start and end of replacement operation.
   *
  ...
  public static boolean equalNodes(AbstractInsnNode a, AbstractInsnNode b) {
    ...
    if (a instanceof InvokeDynamicInsnNode) {
      return ((InvokeDynamicInsnNode) a).name.equals(((InvokeDynamicInsnNode) b).name)
          ...
          && Arrays.equals(
              ((InvokeDynamicInsnNode) a).bsmArgs, ((InvokeDynamicInsnNode) b).bsmArgs);
    }
