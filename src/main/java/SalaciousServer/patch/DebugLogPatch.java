...
public class DebugLogPatch implements ZomboidPatch {
  ...
  public void applyPatch(SalaciousServerClassTransformer transformer) {
    ...
    //	 	DebugType var0, LogSeverity var1, String var2, Object var3, String var4, Object...
    // var5)
    InsnList formatStringVarArgs =
    ...
    AsmUtils.addToInsnList(
        ...
        new MethodInsnNode(
            ...
            "isLogEnabled",
            "(Lzombie/debug/LogSeverity;Lzombie/debug/DebugType;)Z"),
    ...
    AsmUtils.replaceFirstMatchingLabelNode(
        log,
        node,
        ImmutableList.of(
