...
import SalaciousServer.util.AsmUtils;
...
public class DebugLogStreamPatch implements ZomboidPatch {
  ...
  @Override
  public void applyPatch(SalaciousServerClassTransformer transformer) {

    // private void write(PrintStream var1, String var2)
    replaceMethodNode(
        transformer.getInstructionsForMethod("write", "(Ljava/io/PrintStream;Ljava/lang/String;)V"),
        3,
        ImmutableList.of(
            new VarInsnNode(Opcodes.ALOAD, 3),
            new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                "SalaciousServer/logging/ZomboidLogger",
                "info",
                "(Ljava/lang/String;)V")));
    // private void writeln(PrintStream var1, LogSeverity var2, String var3, String var4)
    replaceMethodNode(
        transformer.getInstructionsForMethod(
            "writeln",
    ...
    // private void writeln(PrintStream var1, LogSeverity var2, String var3, String var4, Object
    // var5)
    replaceMethodNode(
        transformer.getInstructionsForMethod(
            "writeln",
    ...
    replaceMethodNode(
        transformer.getInstructionsForMethod("debugln", "(Ljava/lang/String;)V"),
        4,
        ImmutableList.of(
            new VarInsnNode(Opcodes.ALOAD, 3),
            new MethodInsnNode(
    ...
    replaceMethodNode(
        transformer.getInstructionsForMethod("debugln", "(Ljava/lang/String;Ljava/lang/Object;)V"),
        4,
        ImmutableList.of(
    ...
    replaceMethodNode(
        transformer.getInstructionsForMethod(
            "debugln", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V"),
        4,
        ImmutableList.of(
            new VarInsnNode(Opcodes.ALOAD, 5),
            new MethodInsnNode(
    ...
    replaceMethodNode(
        transformer.getInstructionsForMethod("println", "(Ljava/lang/String;Ljava/lang/Object;)V"),
        3,
        ImmutableList.of(
            new VarInsnNode(Opcodes.ALOAD, 3),
            new MethodInsnNode(
    ...
    replaceMethodNode(
        transformer.getInstructionsForMethod(
            "println", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V"),
        3,
        ImmutableList.of(
            new VarInsnNode(Opcodes.ALOAD, 4),
            new MethodInsnNode(
    ...
    AsmUtils.addToInsnList(
        ...
        new FieldInsnNode(
            Opcodes.GETSTATIC,
            "zombie/debug/DebugLogStream$1",
            "$SwitchMap$zombie$debug$LogSeverity",
            "[I"),
        new VarInsnNode(Opcodes.ALOAD, 4),
        new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "zombie/debug/LogSeverity", "ordinal", "()I"),
  ...
  private void replaceMethodNode(
      InsnList instructions, int labelIndex, List<AbstractInsnNode> content) {
