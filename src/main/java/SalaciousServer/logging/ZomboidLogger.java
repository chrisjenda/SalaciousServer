...
public class ZomboidLogger {
  ...
  static {
    ...
    // print SalaciousServer and Zomboid logs to debug console
  ...
  private enum LogSeverity {
    ...
    /**
     * Returns {@link Level} associated with a {@link LogSeverity LogSeverity} entry matched by
     * given name. If no entry was found a level associated with a specified default {@code
     * LogSeverity} entry will be used instead.
     *
     ...
     * @return {@code Level} associated with matched entry or {@code Level} associated with default
     *     entry if no entry was matched for given name.
     */
  ...
  /**
   * This class represents a {@link PrintStream} for {@link UIDebugConsole}. Any content printed by
   * this {@code PrintStream} will automatically print to the in-game UI debug console which is
   * viewable by players when playing.
   */
